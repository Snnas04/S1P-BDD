...
select '123-98',substring_index('123-98','-',1),substring_index('123-98','-',-1), 
substring_index('123-98','-',1)+substring_index('123-98','-',-1;



select total_punts('78-100'); -- 178
select elocal,evisitant,resultat,total_punts(resultat) PUNTS from partit; -- Check your function with this query
